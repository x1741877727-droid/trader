...
export const translations = {
  en: {
    ...
    decisionRejected: 'Analysis Completed - Decision Rejected',
    ...
    active: 'Active',
    pendingLimitOrders: 'Pending Limit Orders',
    waiting: 'waiting',
    symbol: 'Symbol',
    side: 'Side',
    ...
    snapshotPlaceholder: 'No request snapshot has been uploaded for this trade.',
    majorDecisions: 'Major Decisions Timeline',
    majorDecisionsEmpty: 'No lifecycle entries recorded for this trade yet.',
    majorDecisionStep: 'Decision #{index}',
    closeReviewSummaryTitle: 'Close Review Summary',
    closeReviewMissing: 'No close review has been submitted yet.',
    closeReviewActionHint: 'POST /api/trades/{tradeId}/close-review to upload the AI review payload.',
    ...
    tradePnL: 'Trade P&L',
    tradePnLPct: 'Trade P&L %',
    marginUsedShort: 'Margin Used',
    reviewHighlights: 'What Went Well',
    improvementAreas: 'Improvement Areas',
    rootCause: 'Root Cause',
    extremeReview: 'Extreme Intervention Review',
    reasoningLabel: 'Reasoning',
    actionItems: 'Action Items',
    owner: 'Owner',
    due: 'Due',
    loadingReview: 'Fetching close review...',
    closeModal: 'Close',
    stopLoss: 'Stop Loss',
    latest: 'Latest',
  ...
  zh: {
    ...
    stopped: '已停止',
    decisionError: '决策错误',
    decisionWarning: '决策警告',
    decisionRejected: '分析完成 - 决策被拦截',
    adminMode: '管理员模式',
    logout: '退出',
    switchTrader: '切换交易员:',
    view: '查看',
    ...
    snapshotPlaceholder: '当前交易尚未上传请求快照。',
    majorDecisions: '重大决策时间轴',
    majorDecisionsEmpty: '尚无生命周期记录。',
    majorDecisionStep: '第{index}次动作',
    closeReviewSummaryTitle: '复盘摘要',
    closeReviewMissing: '尚未提交复盘。',
    closeReviewActionHint: '调用 POST /api/trades/{tradeId}/close-review 上传AI复盘结果。',
    confidenceScore: '信心度',
    entry: '入场',
    exit: '出场',
    entryTime: '入场时间',
    ...
    tradePnL: '交易盈亏',
    tradePnLPct: '盈亏百分比',
    marginUsedShort: '占用保证金',
    reviewHighlights: '亮点',
    improvementAreas: '改进项',
    rootCause: '根因分析',
    extremeReview: '极端干预复盘',
    reasoningLabel: '推理',
    actionItems: '行动项',
    owner: '负责人',
    due: '截止',
    loadingReview: '正在获取复盘...',
    closeModal: '关闭',
    stopLoss: '止损',
    latest: '最新',
